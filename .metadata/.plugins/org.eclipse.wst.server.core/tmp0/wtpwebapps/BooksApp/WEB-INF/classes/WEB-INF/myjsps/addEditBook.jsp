		...
		<form:form action="saveUpdateBook" method="post"
			...
			<table>
				...
				<tr>
					...
					<td><font color=green size=4><form:errors path="bname" /></font></td>
				</tr>

				<tr>
					<td>Author</td>
					<td><form:input path="author" /></td>
					<td><font color=green size=4><form:errors path="author" /></font></td>
				</tr>

				<tr>
					<td>price</td>
					<td><form:input path="price" /></td>
					<td><font color=green size=4><form:errors path="price" /></font></td>
				</tr>
				...
				<tr>
					...
					<td><font color=green size=4><form:errors
				...
				<tr>
					...
					<td><font color=green size=4><form:errors path="pub" /></font></td>
				</tr>
